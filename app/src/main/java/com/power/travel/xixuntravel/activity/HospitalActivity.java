...
public class HospitalActivity extends BaseActivity implements
	...
	private String data, TAG = "HospitalActivity", info, mobile;
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 1) {// 成功
				...
				if (page == 1) {
					adapter = new RescuePhoneAdapter(HospitalActivity.this, adapterList);
			...
			if (pd != null && HospitalActivity.this != null) {
				pd.dismiss();
			}
			if (HospitalActivity.this != null && mListView != null) {
