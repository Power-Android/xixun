...
public class ViewspotDetailGridAdapter extends BaseAdapter {
	...
	public ViewspotDetailGridAdapter(String pic_link, Context context, int type) {
	...
	public ViewspotDetailGridAdapter(String[] pic_link,
			Context context) {
		mLayoutInflater = LayoutInflater.from(context);
		mContext = context;
	...
	public ViewspotDetailGridAdapter(ArrayList<String> list_url, Context context,
                                     int type) {
		mLayoutInflater = LayoutInflater.from(context);
		mContext = context;
		mType = type;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (mPic_list.size() > 1) {
			...
			imageLoader.displayImage(HttpUrl.Url+url, viewHolder.imageView, options,
			...
			imageLoader.displayImage(HttpUrl.Url+url, viewHolder.imageView2, options,
					animateFirstListener);
		}
		...
		viewHolder.imageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent mIntent = ImageViewPager_ViewspotDetailActivity.newIntent(mContext, mPic_list, po);
