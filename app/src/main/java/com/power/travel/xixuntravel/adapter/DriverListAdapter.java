 ...
 *
 */
public class DriverListAdapter extends BaseAdapter implements OnClickListener {
	...
	DriverListOnItemOnClickListener onItemOnClickListener ;
	
	public DriverListAdapter(Context context, List<DriverModel> list) {
		super();
...
//		.cacheInMemory(true)// 是否緩存都內存中
	...
	public void DriverListOnItemOnClickListener(DriverListOnItemOnClickListener onItemOnClickListener ){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.item_driverlist_layout, null, false);
		
			holder.nickname = (TextView) convertView
					.findViewById(R.id.item_driver_nickname);
			holder.age = (TextView) convertView
					.findViewById(R.id.item_driver_age);
			holder.worktime = (TextView) convertView
					.findViewById(R.id.item_driver_worktime);
			holder.phone = (TextView) convertView
					.findViewById(R.id.item_driver_phone);
			holder.nation = (TextView) convertView
					.findViewById(R.id.item_driver_nation);
			holder.address = (TextView) convertView
					.findViewById(R.id.item_driver_address);
			holder.distance = (TextView) convertView
					.findViewById(R.id.item_driver_distance);
			holder.sex = (ImageView) convertView
					.findViewById(R.id.item_driver_sex);
			holder.face = (ImageView) convertView
					.findViewById(R.id.item_driver_face);
			holder.item_driver_chat= (ImageView) convertView
					.findViewById(R.id.item_driver_chat);
		...
		holder.worktime.setText("驾龄："+list.get(position).getWorktime()+"年");
		...
		holder.item_driver_chat.setOnClickListener(this);
		holder.item_driver_chat.setTag(position);
		return convertView;
	}

	final class ViewHolder {
		TextView nickname,age,worktime,phone,nation,address,distance;
		ImageView sex,face,item_driver_chat;
	}
