...
public class DevMountInfo {
                ...
                if (mStorageManager != null) {
                        ...
                        try {
                                ...
                                if (mStorageVolumeList != null && mStorageVolumeList.length > 0) {
                                        ...
                                        if(true){
                                                Log.e(TAG, "init() === > StorageVolume Count = " + mStorageVolumeCount);
                                        }
                                        ...
                                        for (int i = 0; i < mStorageVolumeCount; ++i) {
                                                ...
                                                if (!TextUtils.isEmpty(mStoragePath)) {
                                                        ...
                                                        if ((state != null) && (state.equals(MOUNTED))) {
                                                                if (mIsRemovable) {
                                                                        if(true){
                                                                                Log.e(TAG, "init() === > external storage path = (" + mStoragePath + ")");
                                                                        }
                                                                        mExternalPathList.add(mStoragePath);
                                                                } else {
                                                                        if(true){
                                                                                Log.e(TAG, "init() === > internal storage path = (" + mStoragePath + ")");
                                                                        }
        ...
        private void initSDCardPath() {
                ...
                if(true){
                        Log.e(TAG, "initSDCardPath() === > SDCARD PATH = (" + mSDCardPath + ")");
                }
        }
