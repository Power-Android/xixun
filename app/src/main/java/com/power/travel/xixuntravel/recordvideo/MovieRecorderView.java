...
public class MovieRecorderView extends LinearLayout implements OnErrorListener {
    ...
    public MovieRecorderView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mWidth = a.getInteger(R.styleable.MovieRecorderView_record_width, 320);//默认720
        mHeight = a.getInteger(R.styleable.MovieRecorderView_record_height, 240);//默认480.
...
//		surfaceView.setLayoutParams(imagebtn_params);
...
//            LogUtil.e(LOG_TAG, recordFile.getAbsolutePath());
    ...
    private void initRecord() throws Exception {
        ...
        LogUtil.e(LOG_TAG,"设置分辨率setVideoSize===="+mWidth+","+mHeight);
