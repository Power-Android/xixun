 ...
 * 
 */
public class ImageViewPager_ViewspotDetailActivity extends Activity implements OnClickListener {
...
//	MyTravelModel travelModel;
	...
	public static Intent newIntent(Context mContext, ArrayList<String> pic_List, int position) {
		Intent i = new Intent(mContext, ImageViewPager_ViewspotDetailActivity.class);
...
//		Log.e("mlist_pic-viewpager---", mList_pic.size() + "");
		for (int i = 0; i < mList_pic.size(); i++) {
			...
			String image_url = HttpUrl.Url+mList_pic.get(i);
