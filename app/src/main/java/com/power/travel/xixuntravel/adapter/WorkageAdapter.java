 ...
 * 
 */
public class WorkageAdapter extends BaseAdapter implements OnClickListener {

	private LayoutInflater inflater;
	Context context;
	int mPosition;
	
	private List<WorkageModel> list = new ArrayList<WorkageModel>();
	
	public WorkageAdapter(Context context, List<WorkageModel> list) {
		super();
