...
import com.power.travel.xixuntravel.adapter.DriverListAdapter;
...
public class DriverListActivity extends BaseActivity implements
        OnRefreshListener2<ListView>,DriverListOnItemOnClickListener {
	private ImageView back;
	private TextView title,sex_tv,worktime_tv,age_tv,nation_tv;
	private String data, TAG = "DriverListActivity", info, mobile;
	private ProgressDialogUtils pd;
	private PullToRefreshListView mListView;
	List<DriverModel> adapterList = new ArrayList<DriverModel>();
	List<DriverModel> adapterListMore = new ArrayList<DriverModel>();
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 1) {// 成功
				...
				if (page == 1) {
					adapter = new DriverListAdapter(DriverListActivity.this, adapterList);
					adapter.DriverListOnItemOnClickListener(DriverListActivity.this);
			...
			if (pd != null && DriverListActivity.this != null) {
				pd.dismiss();
			}
			if (DriverListActivity.this != null && mListView != null) {
	...
	protected void onCreate(Bundle arg0) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent=new Intent(DriverListActivity.this,UserCenterActivity.class);
	...
	public void OnItemClick(int typeint, int position) {
		...
		case 1:
			if (sp.getBoolean(XZContranst.if_login, false)) {
				 ...
				 * 进入融云
				 */
//			 RongIM.getInstance().startPrivateChat(this,adapterList.get(position).getMid() , adapterList.get(position).getNickname());
			} else {
				startActivity(new Intent(DriverListActivity.this, LoginActivity.class));
			}
			break;
	...
	private void initmPopupWindowView() {
		...
		sexAdapter = new SexAdapter(DriverListActivity.this, sexList);
	...
	private void initmWorkagePopupWindowView() {
		...
		workageAdapter = new WorkageAdapter(DriverListActivity.this, workageList);
	...
	private void initmagePopupWindowView() {
		...
		ageAdapter = new AgeAdapter(DriverListActivity.this, ageList);
	...
	private void initmnationPopupWindowView() {
		...
		nationAdapter = new NationAdapter(DriverListActivity.this, nationList);
