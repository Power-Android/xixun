...
import com.power.travel.xixuntravel.activity.ImageViewPager_2Activity;
 ...
 * 
 */
public class TravelDetailGridAdapter extends BaseAdapter {
	...
	public TravelDetailGridAdapter(String pic_link, Context context, int type) {
	...
	public TravelDetailGridAdapter(String[] pic_link,
			Context context) {
		mLayoutInflater = LayoutInflater.from(context);
		mContext = context;
	...
	public TravelDetailGridAdapter(ArrayList<String> list_url, Context context,
                                   int type) {
		mLayoutInflater = LayoutInflater.from(context);
		mContext = context;
		mType = type;
		if (type == PIC_PATH) {
			...
			screenHeight = ((Activity) mContext).getWindowManager()
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mLayoutInflater.inflate(
					R.layout.traveldetail_image_layout, parent, false);
			viewHolder.imageView = (MyImageViewSize) convertView
					.findViewById(R.id.iv_user_img);
			viewHolder.imageView2 = (MyImageViewSize) convertView
					.findViewById(R.id.iv_user_img2);
			// 用来监听ImageView的宽和高
		...
		// Bitmap mBitmap = ImageUtils.getSampledBitmapFromFile(url,
		...
		viewHolder.imageView.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent mIntent = ImageViewPager_2Activity.newIntent(mContext, mPic_list, po);
