...
package com.power.travel.xixuntravel.widget;
...
import com.power.travel.xixuntravel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private int[] SHADOWS_COLORS = new int[] { 0xefEEEEEE, 0xcfEEEEEE,
			0x00EEEEEE };
	...
	private void drawCenterRect(Canvas canvas) {
		...
		/*
		 * / Remarked by wulianghuan 2014-11-27 娴ｈ法鏁ら懛顏勭箒閻ㄥ嫮鏁剧痪鍖＄礉閼板奔绗夐弰顖涘伎鏉堬拷
		...
		// 设置线的颜色
		paint.setColor(getResources().getColor(R.color.line_gray4));
		// 设置线宽
		paint.setStrokeWidth((float) 3);
		// 绘制上边直线
		// canvas.drawLine(0, center - (int)(offset*2.5), getWidth(), center -
		// (int)(offset*2.5), paint);
