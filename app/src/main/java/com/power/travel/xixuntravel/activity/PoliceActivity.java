 ...
 * 
 */
public class PoliceActivity extends BaseActivity implements
        OnRefreshListener2<ListView> {

	private ImageView back;
	private TextView title;
	private String data, TAG = "PoliceActivity", info, mobile;
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			if (msg.what == 1) {// 成功
				...
				if (page == 1) {
					adapter = new RescuePhoneAdapter(PoliceActivity.this, adapterList);
			...
			if (pd != null && PoliceActivity.this != null) {
				pd.dismiss();
			}
			if (PoliceActivity.this != null && mListView != null) {
