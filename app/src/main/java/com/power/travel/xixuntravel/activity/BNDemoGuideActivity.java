...
public class BNDemoGuideActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewsoptDetailActivity.activityList.add(this);
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(ViewsoptDetailActivity.ROUTE_PLAN_NODE);
    ...
    protected void onDestroy() {
        ...
        ViewsoptDetailActivity.activityList.remove(this);
    ...
    private void addCustomizedLayerItems() {
        ...
        if (mBNRoutePlanNode != null) {
            item1 = new CustomizedLayerItem(mBNRoutePlanNode.getLongitude(), mBNRoutePlanNode.getLatitude(),
                    mBNRoutePlanNode.getCoordinateType(), getResources().getDrawable(R.drawable.logo),
                ...
                public void handleMessage(android.os.Message msg) {
                    if (msg.what == MSG_SHOW) {
                        ...
                        BNRouteGuideManager.getInstance().resetEndNodeInNavi(
                                new BNRoutePlanNode(Double.parseDouble(spLocation.getString(XZContranst.coordinate_x, "116.40386525193937")),
                						Double.parseDouble(spLocation.getString(XZContranst.coordinate_y, "39.915160800132085"))
                						, spLocation.getString(XZContranst.location_country, ""), null, CoordinateType.GCJ02));
                    }
                };
            };
        }
